...
Console.WriteLine("Проверим существует ли треугольник с введенными Вами сторонами");
...
Console.WriteLine(result ? "да, существует" : "нет, такого треугольника не существует");